...
import 'package:game_template/src/control/control.dart';
...
class _CustomNameDialogState extends State<CustomNameDialog> {
      ...
      child: SimpleDialog(
        ...
        children: [
          TextField(
            ...
            onChanged: (value) {
              context.read<ControlController>().setPlayerName(value);
            },
            onSubmitted: (value) {
  ...
  void didChangeDependencies() {
    _controller.text = context.read<ControlController>().playerName.value;
